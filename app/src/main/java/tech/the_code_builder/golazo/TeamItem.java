...
public class TeamItem extends ArrayAdapter {
    ...
    TeamItem(Activity context, ArrayList<String> name, ArrayList<String> dept, ArrayList<String> pos,ArrayList<String> point ){
